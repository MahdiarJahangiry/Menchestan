...
namespace Menchestan
{
    namespace IAB
    {
        namespace IABItems
        {
            public class PieceRingItem : GoodItem
            {
                public Image icon;
                ...
                {
                    ServerKit.Instance.UpdateData(GameManager.Instance.user, new Dictionary<string, object>() { { "selectedPieceRing", good.key } }, OnSelectionChanged);
                }
                ...
                public override void SetData()
                {
                    ...
                    if (GameManager.Instance.user.pieceRings.Contains(good.key))
                    {
                        sourceIcon.gameObject.SetActive(false);
                        if (good.key == GameManager.Instance.user.selectedPieceRing)
                        {
